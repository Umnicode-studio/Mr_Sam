/*void UFrameworkUtils::GetClosestInteractPawn(APawn* WorldContextObject, float MinDistance, APawn *&Pawn, float &Distance, UInteraction *&PawnInteraction,
                                             UGameObjectComponent *&PawnGameObject)
{
    Distance = -1;
    Pawn = nullptr;
    ...
    if (Registry)
    {
        ...
        TArray<UGameObjectComponent *> FoundGameObjects = Registry->GameObjectsList;

        for (UGameObjectComponent *GameObject : FoundGameObjects)
        {
